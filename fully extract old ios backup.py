...
# Make a backup of your old iOS device (I used 3uTools)
# If you cannot se this script if your backup has the format of a single folder with many files with hexadecimal names and Manifest.mbdb
